...
def test_memory_event_query_page_is_registered_and_cache_busted():
    ...
    assert "ADMIN_UI_FRAGMENT_VERSION = 'brief-216-memory-event-control-1'" in core
    assert '<script src="/static/js/core.js?v=brief-216-memory-event-control-1"></script>' in index
